...
All projects
GSSF
You are the GSSF Strategy AI Agent. You represent the source of truth for the Global Student Startup Foundation and all it's programs. We will be using this project to manage GSSF and to create/edit programs. don't create word docs.
Created by you
·
Shared
Show more
...
MOU creation with ALC for GSSF
Last message 4 days ago
GSSC Venture Intelligence Platform PRD
Last message 7 days ago
Shared
Teams and startup descriptions
Last message 13 days ago
TAM, SAM, SOM for GSSF
Last message 13 days ago
GSSC sponsorship page structure
Last message 14 days ago
Visa letter for Amy Jiang
Last message 17 days ago
Budget planning assistance
Last message 18 days ago
Global student startup conference in Seoul
Last message 21 days ago
Understanding our mission
Last message 21 days ago
Mike Lee's full biography
Last message 25 days ago
GSSF website export comparison
Last message 25 days ago
...
Last message 26 days ago
Shared
Mentor to team matching process
Last message 27 days ago
create a bio for Selina Mejia,...
Last message 27 days ago
USC sponsored participation decision
Last message 30 days ago
Creating an additional bio
Last message 1 month ago
GSSF Advisory service framework
Last message 1 month ago
Globalizing opportunity through applied AI curriculum
Last message 1 month ago
Weekly credits check
Last message 1 month ago
Governance policies and website documentation
Last message 1 month ago
2027 strategic plan with global AI Cup and regional competitions
Last message 1 month ago
Email to Tel Aviv University about Global Student Startup Competition
Last message 1 month ago
GSSF OLD
Last message 1 month ago
Memory
Only you
Purpose & context Mike Lee (mikelee@usc.edu) is the Founder & Chairman of the Global Student Startup Foundation (GSSF) and its flagship program, the Global Student Startup Competition (GSSC). GSSF is a U.S.-based 501(c)(3) nonprofit (EIN: 41-3141550, 1837 McFarlane Street, San Marino, CA 91108) running six programs: GSSC, Global AI Cup, GSSF Academy, GSSF Ventures, GSSF Advisory, and GSSF AI Labs. Mike also teaches digital entrepreneurship and applied AI at USC's Viterbi School of Engineering (Department of Technology & Applied Computing / TAC), where his direct manager is Kendra Walther. GSSC Worlds 2026 is the immediate operational focus — a global undergraduate startup competition held May 17–21, 2026 in Seoul, South Korea as an official side event of the Asian Leadership Conference (ALC). The event features 16 competing teams from universities including IIT Delhi, Ashoka, USC, Stanford, Oxford, Aalto, and UC Berkeley, with mentors from Google, OpenAI, TikTok, Duolingo, Alchemist Accelerator, Techstars, and others. Key people & collaborators: Liz Lee — Co-Founder, Advisory Asia & US (liz@globalstudentstartup.org, associated with I in We) Carolina Avila — Founder & CEO, GSSF Academy Bob Upham — Head of Mentors, UC Berkeley (Academic Collaborator) Ricardo Marvão — Co-Founder, Academy Advisor & Regional Advisor, Europe Nitin Kale — Global Advisor & Regional Advisor, India (USC Viterbi Professor, BITS alumnus) Miraya Agarwal — Built the India regional model (former USC senior) Tun — Founding Engineer (working on Venture Intelligence Platform) Mirae — Key ALC contact Vy and Timothy Li Family Foundation — Major donor ($50K Grand Prize gift, co-sponsored with UC Berkeley SCET) Regional advisors: Andres Barreto (Colombia), Maxime Chaury (Singapore), Felix Litvinsky (Ukraine), Jongyeop Seon (South Korea), Selina Mejia (Mexico), Dolapo Sunmola (Nigeria), Timothy Li (Asia), Manuela Berrio (Colombia), Praew Kedpradit (Director, Creative & Brand Strategy), Grace Li (Director, University & Student Relations) Current state GSSC Worlds 2026 logistics: 16 teams confirmed; visa letters generated for 19 participants using the sealed GSSF template. Visa letter base template stored at /home/claude/visatemplatesealed.docx — use for all future visa letters. Fundraising: GSSC Worlds 2026 global Zeffy campaign ($100K) is finalized and live. Campaign title: "Send the World's Best Student Founders to GSSC Worlds 2026." Individual university pages (IIT Delhi, Aalto, etc.) link to this as the central donation destination. Additional regional campaigns exist for IIT Delhi, Aalto, Korean team Silicon Valley prize, BITS Pilani (2027), and Colombia (2027). ALC budget: ALC confirmed commitment covering near-breakeven operations including Shilla Hotel accommodations for mentors and judges. Exchange rate movement (KRW/USD) created a shortfall that was resolved through ALC's increased commitment. GSSC Venture Intelligence Platform: PRD v4 completed — a Neo4j knowledge graph system with 13 use cases, 8 entity types, 17 relationships, 6 roles (ADMIN, ORGANIZER, MENTOR, JUDGE, STUDENT, UNIVERSITYPOC), and a 10-concurrent-user ceiling justifying a single VM with Neo4j CE. Built with Tun (engineering) and Bob Upham (academic collaboration). Mentor matching: Full matching recommendations produced for GSSC Academy teams (3 mentors per team). Six mentors with uncontested primary assignments identified; contested assignments (Adrian Spanu, Amy Jiang, J.K.) pending resolution. USC relationship: Navigating institutional relationship with TAC department. GSSC is an independent nonprofit; USC participation represents student benefits, not a formal USC program. Mike has been exploring ways to find a home for GSSC within USC. On the horizon GSSC Worlds 2026 execution (May 17–21, 2026): Pitch scheduling, judge onboarding/conflict declaration, score aggregation, bulk visa letter generation, sponsor impact reporting — all mapped as use cases in the PRD. 2027 strategic plan: Active regions planned — Ukraine, Colombia, Singapore, India, Busan; contingent regions (Mexico, Taiwan, Shanghai) pending funding. Minimum 5 qualifying regions for both Global AI Cup and GSSC Regionals. Patron regional sponsorship set at $30K USD. Global AI Cup: Primary distribution vehicle for Mike's applied AI curriculum (TAC 400 / "Building Personal AI Agents"). GSSF AI Builder Playbook created for participants. TAU (Tel Aviv University) outreach: Exploring GSSC regional qualifying competition; introduction facilitated through Shay Bar. Fundraising transition: Moving from university-based funding toward alumni, diaspora, and mission-driven foundation funding. Key prospects: Korea-America Chamber of Commerce, Patrick Yoon (USC alumnus), James Kim (UCLA graduate, former Microsoft Korea chairman). GSSF Advisory pilot: Planned for 2027 (Goal 7 in Strategic Plan). Neo4j platform Phase 2/3: Matching engine and OWL/neosemantics integration planned; if dropped, Postgres would be the simpler alternative. USC AI Cup and "Building Personal AI Agents" class: Three sections planned for Fall 2026. Key learnings & principles Website is the source of truth: All internal documents should be aligned to foundation.globalstudentstartup.org, not the reverse. When discrepancies arise, cross-check against the website first. Fundraising language discipline: Remove "85% programmatic" language from all donor-facing copy. No dollar amounts in narrative team story copy. All CTAs route to a single Contact Us page (foundation.globalstudentstartup.org/contact). Wire transfer details (Relay domestic, Wise international) are never public — available only upon private request. Role/title precision: "Regional Chair" (not "Managing Director" or "Founding") for pre-operational regions; clean progression to "Managing Director" once milestones are hit. ADMIN is an elevated ORGANIZER on the same Person node in the graph model. Sponsor structure: Co-sponsorship model with ALC is clean — GSSF pitches sponsors on ALC's behalf; sponsors receive travel coverage and branding at ALC rather than cash flowing through GSSF. Neo4j justification: Graph database is warranted specifically for relationship traversal (mentor matching, longitudinal tracking, conflict detection) and Phase 2/3 features — not data volume alone. Named scholarships: $25,000 USD per international team; ₩15,000,000 KRW for Korean teams. University-level scholarships reserved for founding partner universities (2025–2026). Team composition standard: "Up to 5 competing students" per team across all materials. Approach & patterns Iterative document refinement: Mike reviews full document content before approving file generation; prefers targeted edits confirmed with a simple "yes" or "this is good" before regenerating. Requests full re-display after each change to confirm accuracy. Plain text first: Prefers plain text content drafts before formatting. Communication style: Legitimacy-forward, opportunity-focused framing; avoids presumptuous or negative language in outreach. Direct, honest strategic advice preferred over purely deferential guidance. Document workflow: Website as source of truth → audit internal docs → regenerate updated versions as new output files (project .md files are read-only). Docx generation uses node.js scripts; validation via python3 /mnt/skills/public/docx/scripts/office/validate.py. Visa letter workflow: Use /home/claude/visatemplatesealed.docx as base. American date format. Slugify names with re.sub(r'[^\w]', '', name.encode('ascii','ignore').decode()) for special characters. Batch generation with per-participant date/role customization. Tools & resources Zeffy: Fundraising campaigns (global + regional university-specific) Neo4j CE: Knowledge graph for Venture Intelligence Platform (single 2-vCPU/4GB RAM VM) Figma / Figma Make: Website page design and implementation prompts Relay (domestic wire) / Wise (international wire): Banking — never listed publicly foundation.globalstudentstartup.org: Primary public-facing foundation website (source of truth) globalstudentstartup.org: GSSC competition website Social: LinkedIn (linkedin.com/company/globalstudentstartup), Instagram (@globalstudentstartup) Project file references: GSSFTeamBiosExport.md, GSSFLeadership__AdvisorBios, GSSFWebsiteContentExport.md, 2026GSSCMasterList_Logistics1.xlsx, /home/claude/visatemplatesealed.docx GSSF brand: Primary blue #242EC0, deep navy #08044C; Noto Sans typography; "GS/SF" stacked letterform logo (no borders)
...
GSSF_Development_Strategy_2026_2030.docx
305 lines
...
GSSF_2027_Strategic_Plan_Updated.md
265 lines
...
GSSF_Strategic_Knowledge_Repository_Updated.md
258 lines
...
GSSC_Academy_Whitepaper_Updated.docx
314 lines
...
GSSF_Website_Content_Export.md
414 lines
...
Global Student Startup Foundation.docx
211 lines
...
GSSC_Zeffy_Campaign_Descriptions.docx
449 lines
...
GSSC_Operating_Guidelines___Sections_10___11__Revised_.md
187 lines
...
GSSC 2026 Support Framework.docx
99 lines
...
GSSF_Advisory_Methodology.docx
416 lines
...
Figma Instructions: Global AI Cup Page — foundation.globalstudentstartup.org.md
115 lines
...
GSSF IRS Tax Exemption Approval.pdf
pdf
...
GSSC x USC Opening Statements.pdf
pdf


GSSC branding visual.pdf
pdf


GSSFlogos.png

GSSC Academy Deck.v3.pdf
pdf



2026 GSSC Master List Logistics 1.xlsx
xlsx
...
Leadership
The foundation is guided by experienced operators,  educators, and ecosystem builders and operated by student organizers who we are developing into future global leaders.
...
For GSSF's programs, Timothy is Head of Global Judging and Master Mentor on Pitching. He brings meticulous attention to evaluation frameworks, pitch clarity, and the ability to translate complex ideas into compelling narratives that resonate with global investors and judges.

As a GSSF Global Advisor and Head of Judging & Pitch, Timothy provides strategic oversight to all programs — bringing the full weight of his fintech expertise, founder network, and institutional relationships to bear on building the pathways that connect the next generation of undergraduate founders to the global stage.
...
Today, as Managing Partner of Asesoria Partners, Bob advises startups, corporations, accelerators, and universities across the globe on fundraising, product strategy, go-to-market, and US market entry. He mentors founders through Techstars Tokyo, AlchemistX, The Batchery, and ESADE, and serves as a Program Development Fellow at UC Berkeley — where he has supported entrepreneurship programs for nearly a decade.

As GSSF's Head of Mentors, Bob brings his global network, Silicon Valley credibility, and founder-first mentality to bear on the world's most promising undergraduate founders — connecting them to the people, capital, and frameworks they need to build what's next.

Read less
Jade Bahng
Jade Bahng
Co-Founder & Managing Director, Global Competition
...
Yeseul Byun
Yeseul Byun
Managing Director, Global Competition
...
Her technical credentials are exceptional. She spent nine months as a Software Engineering Intern at NASA's Jet Propulsion Laboratory in Los Angeles — one of the most competitive engineering placements in the world — and previously interned as an AI Intern at Blackbox in Singapore, giving her firsthand exposure to how AI is being built and applied across two of the world's most dynamic tech ecosystems. She continues that research focus as a Research Assistant at USC's Information Sciences Institute, one of the country's premier applied computing research centers, and brings her engineering skills to Code the Change, an organization dedicated to building technology for social good.

Grace is equally accomplished as an institution builder. As Director of Technology at Trojan Marketing Group for two years, she led the technical infrastructure of USC's 70+ person student-run professional agency. As VP of Internal Affairs at SEP at USC, she has spent over two years shaping the internal operations of one of USC's most active entrepreneurship organizations. Earlier, she served as a Research Assistant at UC San Diego for three years — establishing a research foundation that predates her USC career and signals a sustained intellectual curiosity that runs through everything she does.

As GSSF's Director of University & Student Relations, Grace is responsible for building and maintaining the university partnerships and student pipelines that power GSSF's global programs — translating the foundation's mission into relationships, on-campus presence, and student communities that extend GSSF's reach one campus at a time.

Read less
Jongyeop (Colin) Seon
Jongyeop (Colin) Seon
Director, Korea Relations
...
Colin brings to this role something few could offer: he is himself a builder of exactly the kind of company GSSF exists to elevate. In 2021, he founded Lutra — a tech startup born as a student project — and led it to become the youngest Korean team to win at CES, taking home the 2023 Innovation Award, a first for its category. Since then, Lutra has been invited to events hosted by South Korea's President's Office and the Ministry of Science and ICT. Having successfully executed two AI and blockchain technology licensing deals, Lutra is now expanding into the North American market, backed by Google and OpenAI's startup programs. Recognizing his outstanding achievements, Colin was also honored as a recipient of the prestigious 2025 Talent Award of Korea.

Lutra's current flagship product is a blockchain-based 'Proof' camera, gaining strong traction as a vital AI security solution designed to combat fake photos and images in the age of AI.

Read less
Manuela Berrio
Manuela Berrio
Director, Programming & Mentor Relations

LinkedIn
A builder at heart, Manuela brings a rare combination of computer science and business administration to her role at GSSF. A USC Viterbi student and Teaching Assistant for TAC499: Building Personal AI Agents, she operates at the cutting edge of applied AI — having spoken at the AI4 Artificial Intelligence Conference in Las Vegas and interned across AR/AI/Robotics, UX/UI design, and software development. As Director of Programming and Mentor Relations for GSSC at USC, she already lives inside the GSSF ecosystem, bringing firsthand understanding of what it takes to run world-class programs and connect students with the right mentors. What distinguishes Manuela is her deep commitment to building opportunities for underserved communities — she leads with both technical rigor and a people-centered instinct that turns programs into movements.
...
Her experience reflects both range and depth. As GSSF's Marketing Director and Social Media Manager, she already operates inside the ecosystem she is now helping to expand — developing the brand voice, digital presence, and marketing strategy that connects student founders across borders. Before that, she served as a Creative Strategist at Quilly, where she led market research, TikTok growth, and campus partnership outreach, and as a Data Analytics Extern at Beats by Dre, where she applied Python and AI tools to analyze Gen Z consumer behavior and translate cultural trends into actionable strategic recommendations.

What distinguishes Selina is the conviction behind her work. Passionate about bringing cultures together through international marketing and expanding access to opportunity for underrepresented communities, she approaches every initiative with the belief that diverse audiences deserve strategies built around them — not adapted for them. Her fluency in consumer insight, content creation, and global brand dynamics makes her uniquely equipped to build the university relationships, community partnerships, and student pipelines that will define GSSF's next chapter.
...
LinkedIn
Praew Kedpradit is a multidisciplinary creative who brings rare convergence of visual storytelling, strategic thinking, and cultural intelligence to her role as GSSF's Director of Creative & Brand Strategy. Raised in Bangkok and now based in Los Angeles, she operates across the full creative spectrum — from brand identity and art direction to consumer insight and campaign strategy — with a sensibility shaped by living and working across two continents.

Her credentials span some of the most culturally resonant institutions in media and entertainment. As a Creative Direction Intern at Sony Music Entertainment in New York, she worked at the intersection of music, visual culture, and artist identity. At Complex Networks, she led PR for high-profile campaigns involving artists including Jennie Kim, Travis Scott, and A$AP Rocky — earning placements in The New York Times, Billboard, and national broadcast outlets and executing on-site at experiential activations that brought brand stories to life. Earlier, as a Production Intern at TAPROD in Bangkok, she supported shoots for Chanel, Samsung, L'Oréal, and KFC, and edited a showreel featuring work for Coca-Cola, Sony, and Marshall — a formative experience that deepened her fluency in global production and international creative standards.

At USC, Praew has built an equally impressive portfolio. As a Creative Strategist at Trojan Marketing Group — USC's 70+ person student-run professional agency — she has led art direction, pitch deck design, and brand asset creation for real client accounts. As Assistant Creative Director for USC Concerts Committee and a Visual Designer for Haute Magazine (770,000+ worldwide views), she has consistently demonstrated the ability to translate creative vision into work that moves audiences.

As GSSF's Director of Creative & Brand Strategy, Praew brings this full range of experience to bear on the foundation's visual identity and brand presence — designing not just what GSSF looks like, but how it is experienced by the students, partners, and institutions it seeks to reach.
...
Gigi Wang
Gigi Wang
Co-Founder, Chair Emeritus & Global Fellow
...
Nitin Kale
Nitin Kale
Global Advisor & Regional Advisor, India
...
Ricardo Marvão
Ricardo Marvão
Academy Advisor & Regional Advisor, Europe
