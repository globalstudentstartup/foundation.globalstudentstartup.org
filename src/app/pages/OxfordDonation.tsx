...
export default function OxfordDonation() {
  const fadeInUp = {
  ...
  return (
    <div className="bg-white">
      <SEO 
        title="Send Oxford's Best Student Founders to GSSC Worlds | GSSF"
        description="Support the Oxford team as they compete at GSSC Worlds 2026 in Seoul. The Global Student Startup Foundation is a 501(c)(3) nonprofit."
        path="/oxford-donation"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <p className="text-sm uppercase tracking-widest text-white/80 mb-6 font-semibold">
              GSSC WORLDS 2026 — OXFORD
            </p>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-tight">
              Oxford is heading to Seoul. Help make it possible.
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-12">
              Somewhere in Oxford, a team of undergraduate students just earned their place on the world stage. They built something real. They competed. And now they are heading to Seoul.
            </p>
