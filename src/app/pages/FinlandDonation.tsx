...
export default function FinlandDonation() {
  const fadeInUp = {
  ...
  return (
    <div className="bg-white">
      <SEO 
        title="Send Finland's Best Student Founders to GSSC Worlds | GSSF"
        description="Support the Aalto University team as they compete at GSSC Worlds 2026 in Seoul. The Global Student Startup Foundation is a 501(c)(3) nonprofit."
        path="/finland-donation"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <p className="text-sm uppercase tracking-widest text-white/80 mb-6 font-semibold">
              GSSC WORLDS 2026 — FINLAND
            </p>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-tight">
              Finland produces world-class founders. Now it's time the world sees them compete.
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-12">
              Somewhere in Espoo, a team of undergraduate students just earned their place on the world stage. They built something real. They competed. And now they are heading to Seoul.
            </p>
            ...
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-6 text-xl text-gray-700 leading-relaxed">
                ...
                <p className="font-semibold text-gray-900">
                  Aalto has already done their part — they earned their spot. Now we need to do ours.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto">
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-6 text-xl text-gray-700 leading-relaxed">
                <p>
                  Social media connects people to the entire world while almost completely ignoring the community right outside the door. Users scroll past influencers and strangers on every continent but rarely encounter the people, places, and events that are actually part of their daily lives. The platforms optimize for global reach and maximum engagement — not for the neighborhood, the campus, or the street you actually live on.
                </p>
                <p>
                  A team from Aalto is building the alternative. Kowi is a hyperlocal social platform where physical presence is the price of admission. Scan a QR code, enter the community, and for one week you can discover local events, connect with people nearby, and engage authentically with the spaces that are actually part of your life. After a week, access resets — keeping interactions intentional, timely, and real rather than passive and infinite. The team is working with a mentor from Disney+.
                </p>
              </div>
            </motion.div>
          </div>
