...
export default function UCBerkeleyDonation() {
  const fadeInUp = {
  ...
  const universities = [
    { name: "UC Berkeley", highlighted: true },
  ...
  return (
    <div className="bg-white">
      <SEO 
        title="Send UC Berkeley's Best Student Founders to GSSC Worlds | GSSF"
        description="Support the UC Berkeley team as they compete at GSSC Worlds 2026 in Seoul. The Global Student Startup Foundation is a 501(c)(3) nonprofit."
        path="/uc-berkeley-donation"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <p className="text-sm uppercase tracking-widest text-white/80 mb-6 font-semibold">
              GSSC WORLDS 2026 — UC BERKELEY
            </p>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-tight">
              UC Berkeley is heading to Seoul. Help make it possible.
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-12">
              Somewhere in Berkeley, a team of undergraduate students just earned their place on the world stage. They built something real. They competed. And now they are heading to Seoul.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto">
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-6 text-xl text-gray-700 leading-relaxed">
                <p>
                  27 million people in the United States alone have limited English proficiency. Most language learning apps treat them all the same — the same lessons, the same structure, the same approach — regardless of what language they actually speak. An Arabic speaker and a French speaker face completely different challenges learning English. Most platforms ignore that entirely.
                </p>
                <p>
                  A team from UC Berkeley is building something different. Cognate uses AI to personalize English learning to a student's native language — targeting the specific grammatical, pronunciation, and structural gaps that arise from that particular linguistic background. Real communication skills, not vocabulary memorization. The team is working with a mentor from Duolingo.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-6 text-xl text-gray-700 leading-relaxed mb-10">
                <p>
                  GSSC Worlds 2026 takes place May 17–21 at the Asian Leadership Conference. The UC Berkeley team will pitch alongside teams from Harvard, Stanford, USC, Cornell, Oxford, Aalto, IIT Delhi, POSTECH, Korea University, Ewha Womans University, Dongseo University, and CMU-Qatar — mentored by professionals from Google, OpenAI, Netflix, TikTok, YouTube, Disney+, and Live Nation.
                </p>
              </div>
          ...
          <motion.div {...fadeInUp}>
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                ...
                >
                  Support UC Berkeley at GSSC Worlds →
                </Button>
              </motion.div>
            </a>
