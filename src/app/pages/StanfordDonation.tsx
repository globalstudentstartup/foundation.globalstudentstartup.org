...
export default function StanfordDonation() {
  const fadeInUp = {
  ...
  const universities = [
    { name: "Stanford", highlighted: true },
  ...
  return (
    <div className="bg-white">
      <SEO 
        title="Send Stanford's Best Student Founders to GSSC Worlds | GSSF"
        description="Support the Stanford team as they compete at GSSC Worlds 2026 in Seoul. The Global Student Startup Foundation is a 501(c)(3) nonprofit."
        path="/stanford-donation"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <p className="text-sm uppercase tracking-widest text-white/80 mb-6 font-semibold">
              GSSC WORLDS 2026 — STANFORD
            </p>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-tight">
              Stanford is heading to Seoul. Help make it possible.
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-12">
              Somewhere in Palo Alto, a team of undergraduate students just earned their place on the world stage. They built something real. They competed. And now they are heading to Seoul.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto">
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-6 text-xl text-gray-700 leading-relaxed">
                <p>
                  Every filmmaker, editor, and video team has lived the same nightmare. Files named "final_v3_really_final." Work overwritten. Creative directions lost forever. The tools that transformed how software teams collaborate — version control, branching, merging — have never existed for video.
                </p>
                <p>
                  The Stanford team is building exactly that. Timeline integrates directly into Adobe Premiere Pro and brings the principles of software development to video editing — letting teams track every change, compare versions side by side, and revert instantly. It also includes an AI assistant that helps editors navigate complex workflows without ever leaving the timeline. The team is working with a mentor from Warner Music Korea.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-6 text-xl text-gray-700 leading-relaxed mb-10">
                <p>
                  GSSC Worlds 2026 takes place May 17–21 at the Asian Leadership Conference. The Stanford team will pitch alongside teams from Harvard, USC, UC Berkeley, Cornell, Oxford, Aalto, IIT Delhi, POSTECH, Korea University, Ewha Womans University, Dongseo University, and CMU-Qatar — mentored by professionals from Google, OpenAI, Netflix, TikTok, YouTube, Disney+, and Live Nation.
                </p>
              </div>
          ...
          <motion.div {...fadeInUp}>
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                ...
                >
                  Support Stanford at GSSC Worlds →
                </Button>
              </motion.div>
            </a>
