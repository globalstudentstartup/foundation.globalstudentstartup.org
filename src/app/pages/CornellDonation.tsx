...
export default function CornellDonation() {
  const fadeInUp = {
  ...
  return (
    <div className="bg-white">
      <SEO 
        title="Send Cornell's Best Student Founders to GSSC Worlds | GSSF"
        description="Support the Cornell team as they compete at GSSC Worlds 2026 in Seoul. The Global Student Startup Foundation is a 501(c)(3) nonprofit."
        path="/cornell-donation"
      />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            <p className="text-sm uppercase tracking-widest text-white/80 mb-6 font-semibold">
              GSSC WORLDS 2026 — CORNELL
            </p>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-tight">
              Cornell is heading to Seoul. Help make it possible.
            </h1>
            <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-12">
              Somewhere in Ithaca, a team of undergraduate students just earned their place on the world stage. They built something real. They competed. And now they are heading to Seoul.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto">
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-6 text-xl text-gray-700 leading-relaxed">
                <p>
                  Small business owners know they need a digital presence. They just don't have the time, skills, or outside perspective to build one that actually works. The gap between knowing you need to be out there and having a brand that actually resonates — that's where most small businesses get stuck.
                </p>
                <p>
                  A team from Cornell is closing that gap with agentic AI. Parcelle doesn't generate content on demand — it acts as a proactive branding partner, identifying what a business's digital footprint needs and building it. Website copy, social content, brand architecture — handled, so founders can focus on what they actually built. The team is working with a mentor from Victory Trainings.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div {...fadeInUp}>
              ...
              <div className="space-y-6 text-xl text-gray-700 leading-relaxed mb-10">
                <p>
                  GSSC Worlds 2026 takes place May 17–21 at the Asian Leadership Conference. The Cornell team will pitch alongside teams from Harvard, Stanford, USC, UC Berkeley, Oxford, Aalto, IIT Delhi, POSTECH, Korea University, Ewha Womans University, Dongseo University, and CMU-Qatar — mentored by professionals from Google, OpenAI, Netflix, TikTok, YouTube, Disney+, and Live Nation.
                </p>
              </div>
          ...
          <motion.div {...fadeInUp}>
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                ...
                >
                  Support Cornell at GSSC Worlds →
                </Button>
              </motion.div>
            </a>
